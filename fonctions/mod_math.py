...
# fonctions
#	DISTANCE(x, y, x2=0, y2=0)
#		-> flaot
#	DISTANCE_3D(x, y, z, x2=0, y2=0, z2=0)
#		-> flaot
#	DIRECTION(x, y, x2=0, y2=0)
#		-> float
#	DIRECTION_3D(x, y, z, x2, y2, z2)
#		-> tuple
#	radian(degre)
#		-> float
#	CoSinus(degre)
...
#	racine(x, n=2)
#		flaot
#	tronquer(valeur, ou=0, _type="ajust")
#		-> float [, int]
#	classer(iterable,_type_=0)
#		-> list
#	fact(n, n0=1)
#		-> int [, float]
#:::::::::::::::::::::::::::::::::::::::::::::::::
...
#:::::::::::::::::::::::::::::::::::::::::::::::::
def DISTANCE_3D(x, y, z, x2=0, y2=0, z2=0):
	"""distance entre (x,y) a (x2,y2)"""
...
def DIRECTION_3D(x, y, z, x2, y2, z2):
	aH = DIRECTION(x, y, x2, y2)
	aV = DIRECTION(y, z, y2, z2)
	if not aV % 90 and x: aV = DIRECTION(x, z, x2, z2)
	return (aH, aV)
...
#:::::::::::::::::::::::::::::::::::::::::::::::::
def fact(n, n0=1):
	"""factorielle de 0 a n, avec n0 comme premier terme"""
    u = n0
    if not n0 and n: u = 1
